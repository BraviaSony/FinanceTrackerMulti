        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4 text-sm text-muted-foreground">
              <p><strong>1. Add Sample Data:</strong> Creates realistic test data across all modules</p>
              <p><strong>2. Remove Sample Data:</strong> Only clears machine-generated data marked with "[SEED]"</p>
              <p><strong>3. Clear ALL Data:</strong> Removes everything including user data (use sparingly)</p>
              <p><strong>Note:</strong> Never delete data with the DANGER button unless you want to clear all test/manual entries</p>
            </div>
          </CardContent>
        </Card>
      </div>
