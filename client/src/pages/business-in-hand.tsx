      ...
      <div className="space-y-6">
        ...
        {businessSummary && (
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-blue-900">Confirmed Value</CardTitle>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-blue-900">Received Value</CardTitle>
